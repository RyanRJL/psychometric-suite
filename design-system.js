  ...
  function buildBatteryInlineBar(){
    ...
    bar.innerHTML = `
      ...
      <div class="ds-inline-bar-section ds-inline-bar-cibasis" hidden>
        <span class="ds-inline-bar-label" title="Which reliability coefficient r the confidence intervals are built from.&#10;&#10;Every interval is score ± z × SD × √(1 − r). This changes only the r, and only for the few measures — almost all D-KEFS — whose published r comes from a small retest study rather than the norm group.">Reliability</span>
        <div class="ds-inline-bar-toggle" role="radiogroup" aria-label="Reliability coefficient basis">
          <button type="button" class="ds-inline-bar-toggle-btn is-active" data-bat-ci-basis="published" role="radio" aria-checked="true"
            title="Uses the manual's own r, paired the way the manual pairs it, so the interval matches the one the manual prints.&#10;&#10;This is the default, and the D-KEFS manual makes that same pairing deliberately — its Table 2.8 shows the working.">Published</button>
          <button type="button" class="ds-inline-bar-toggle-btn" data-bat-ci-basis="corrected" role="radio" aria-checked="false"
            title="Adjusts the manual's r to estimate what it would have been in the normative sample. Statistically tidier pairing — but the resulting number appears in no manual.&#10;&#10;corrected r = 1 − (retest-sample SD² ÷ normative SD²) × (1 − r)&#10;&#10;Affects 46 measures, every one D-KEFS or D-KEFS Advanced. At 95% it moves 13 printed margins — 9 wider, 4 narrower — by at most 2 scaled-score points. The APA note records that it was used.">Corrected</button>
        </div>
      </div>
