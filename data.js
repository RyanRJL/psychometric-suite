...
/* ============================================================
   ...
   WHAT TABLE 4.3'S OWN AVERAGE COLUMN IS NOT. Its footnote a defines the
   average SEM as the RMS of the band SEMs — a summary across ages, not the SEM
   of the average coefficient, and the two differ. The app keeps deriving its
   blank-age interval from Table 4.1's average COEFFICIENT, which is what a
   patient of unknown band actually needs and is published. Backing a
   coefficient out of the average SEM instead would mean storing
   1 - (2.16/15)^2 = .9793 for FSIQ, a number the manual never prints; that is
   the Twenty Questions rule. The cost is two printed margins in 48
   (24 measures x the two offered CI levels), both on a rounding knife-edge:
   FSIQ at 90% prints +/-3 here against +/-4 from the average SEM (3.49 vs
   3.55), and Digit Span Backward at 95% +/-2 against +/-3 (2.49 vs 2.55).
   Entering an age avoids the question entirely, and that path is exact.
