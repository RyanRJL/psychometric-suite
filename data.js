...
/* ACS performance validity indicators — multivariate base rates.
   Holdnack, Millis, Larrabee & Iverson (2013), "Assessing Performance
   Validity with the ACS", ch. 7 of WAIS-IV, WMS-IV, and ACS: Advanced
   Clinical Interpretation (the same volume the OPIE-4 coefficients come
   from), Tables 7.1-7.5. Each cell is the percentage of a group having
   N OR MORE of the five ACS PVT scores (Word Choice, WAIS-IV Reliable
   Digit Span, and the three WMS-IV recognition measures) at or below the
   named base-rate cut-off of the overall clinical sample (n = 371).

   THE RAW CUT-OFF SCORES ARE DELIBERATELY NOT STORED: the chapter
   withholds them for test security ("The actual cut-off scores are
   presented in the ACS technical manual, for reasons of test security
   they are not presented here"), so the clinician reads the number of
   low scores off their ACS score report and this page interprets the
   PATTERN against these published base rates. Never add raw ACS
   cut-offs from any secondary source.

   The columns are cumulative — the prose's own worked examples pin the
   reading (at the 15% cut-off: 22% of the clinical sample, 36% of TBI
   and 11% of the normative sample have one or more low scores; at 10%:
   19/30/7 at one or more, 5/6/1 at two or more). null = the source
   prints a dash. The Anxiety Disorder row appears only in the 25% table
   — a property of the source. Interpretive criteria from the same
   chapter: two or more scores at the 15% or 10% cut-off, or three or
   more at the 25% cut-off, is unusual for most clinical groups EXCEPT
   mild intellectual disability; the worked criterion calls one score at
   or below 15% "possible" and two or more at or below 10% "probable"
   invalid performance, chosen A PRIORI, never after seeing the scores.
   Pinned by check.js §38, including both monotonicity invariants. */
const PVT_ACS_GROUPS = [
  { id: 'clinical',  label: 'Overall clinical sample' },
  { id: 'tbi',       label: 'Moderate–severe TBI' },
  { id: 'templob',   label: 'Temporal lobectomy' },
  { id: 'schiz',     label: 'Schizophrenia' },
  { id: 'mdd',       label: 'Major depressive disorder' },
  { id: 'anxiety',   label: 'Anxiety disorder' },
  { id: 'id',        label: 'Intellectual disability (mild)' },
  { id: 'autism',    label: 'Autistic disorder' },
  { id: 'asperger',  label: "Asperger's syndrome" },
  { id: 'reading',   label: 'Reading disorder' },
  { id: 'math',      label: 'Mathematics disorder' },
  { id: 'adhd',      label: 'ADHD' },
  { id: 'norm',      label: 'WMS-IV normative sample' },
  { id: 'edu8',      label: '≤ 8 years education' },
  { id: 'edu911',    label: '9–11 years education' },
  { id: 'edu12',     label: '12 years education' },
  { id: 'edu1315',   label: '13–15 years education' },
  { id: 'edu16',     label: '≥ 16 years education' },
  { id: 'gai69',     label: 'GAI ≤ 69' },
  { id: 'gai7084',   label: 'GAI 70–84' },
  { id: 'gai8599',   label: 'GAI 85–99' },
  { id: 'gai100114', label: 'GAI 100–114' },
  { id: 'gai115',    label: 'GAI ≥ 115' },
  { id: 'sim',       label: 'Simulators' },
  { id: 'nostim',    label: 'No-stimulus (guessing)' }
];
/* [≥1, ≥2, ≥3, ≥4, ≥5] per group, per cut-off level. */
const PVT_ACS_BASERATES = {
  25: {
    nostim:[100,100,100,92,null], sim:[76,58,38,24,16], clinical:[38,19,6,3,1],
    tbi:[48,18,3,0,0], templob:[29,25,4,0,0], schiz:[71,31,7,2,0],
    mdd:[34,12,2,0,0], anxiety:[8,3,0,0,null], id:[91,88,47,31,13],
    autism:[55,14,9,0,0], asperger:[20,6,0,0,0], reading:[27,0,0,0,0],
    math:[36,5,0,0,0], adhd:[12,9,0,0,0], norm:[23,7,2,0,0],
    edu8:[63,27,7,0,0], edu911:[42,13,5,1,0], edu12:[27,9,3,0,0],
    edu1315:[19,5,2,0,0], edu16:[9,2,0,0,0],
    gai69:[81,38,13,0,0], gai7084:[52,25,10,2,0], gai8599:[28,8,2,0,0],
    gai100114:[13,1,0,0,0], gai115:[4,0,0,0,0]
  },
  15: {
    nostim:[100,100,96,72,null], sim:[70,36,22,12,8], clinical:[22,7,2,0,0],
    tbi:[36,9,0,0,0], templob:[21,4,0,0,0], schiz:[35,9,2,0,0],
    mdd:[16,2,0,0,0], id:[72,41,22,9,0],
    autism:[27,9,5,0,0], asperger:[11,6,0,0,0], reading:[7,0,0,0,0],
    math:[18,0,0,0,0], adhd:[9,3,0,0,0], norm:[11,1,0,0,0],
    edu8:[34,2,0,0,0], edu911:[23,5,1,1,0], edu12:[13,1,0,0,0],
    edu1315:[8,1,0,0,0], edu16:[5,0,0,0,0],
    gai69:[44,13,0,0,0], gai7084:[29,4,1,1,0], gai8599:[12,1,0,0,0],
    gai100114:[7,1,0,0,0], gai115:[0,0,0,0,0]
  },
  10: {
    nostim:[100,100,96,60,null], sim:[64,36,20,10,8], clinical:[19,5,1,0,0],
    tbi:[30,6,0,0,0], templob:[17,0,0,0,0], schiz:[35,7,0,0,0],
    mdd:[12,2,0,0,0], id:[63,31,16,6,0],
    autism:[27,9,0,0,0], asperger:[9,3,0,0,0], reading:[7,0,0,0,0],
    math:[14,0,0,0,0], adhd:[9,3,0,0,0], norm:[7,1,0,0,0],
    edu8:[27,2,0,0,0], edu911:[17,4,1,1,0], edu12:[5,0,0,0,0],
    edu1315:[5,1,0,0,0], edu16:[4,0,0,0,0],
    gai69:[38,6,0,0,0], gai7084:[19,2,1,1,0], gai8599:[7,1,0,0,0],
    gai100114:[4,0,0,0,0], gai115:[0,0,0,0,0]
  },
  5: {
    nostim:[100,100,88,38,null], sim:[40,24,14,10,2], clinical:[9,2,0,0,0],
    tbi:[9,3,0,0,0], templob:[8,0,0,0,0], schiz:[15,2,0,0,0],
    mdd:[4,0,0,0,0], id:[38,13,3,3,0],
    autism:[23,5,0,0,0], asperger:[3,0,0,0,0], reading:[0,0,0,0,0],
    math:[14,0,0,0,0], adhd:[6,3,0,0,0], norm:[2,0,0,0,0],
    edu8:[15,2,0,0,0], edu911:[9,1,0,0,0], edu12:[2,0,0,0,0],
    edu1315:[1,0,0,0,0], edu16:[1,0,0,0,0],
    gai69:[19,6,0,0,0], gai7084:[7,1,0,0,0], gai8599:[2,0,0,0,0],
    gai100114:[1,0,0,0,0], gai115:[0,0,0,0,0]
  },
  2: {
    nostim:[100,92,50,8,null], sim:[22,18,8,4,0], clinical:[4,0,0,0,0],
    tbi:[6,0,0,0,0], templob:[0,0,0,0,0], schiz:[4,0,0,0,0],
    mdd:[1,0,0,0,0], id:[31,3,3,0,0],
    autism:[14,0,0,0,0], asperger:[0,0,0,0,0], reading:[0,0,0,0,0],
    math:[0,0,0,0,0], adhd:[0,0,0,0,0], norm:[1,0,0,0,0],
    edu8:[7,0,0,0,0], edu911:[4,0,0,0,0], edu12:[1,0,0,0,0],
    edu1315:[0,0,0,0,0], edu16:[0,0,0,0,0],
    gai69:[19,0,0,0,0], gai7084:[2,0,0,0,0], gai8599:[1,0,0,0,0],
...
/* The chapter's interpretive criteria, applied a priori:
   ...
   - the worked criterion: 1 at or below 15% = "possible", >= 2 at or
     below 10% = "probable" invalid performance. */
const PVT_ACS_RULES = { unusual: { 25: 3, 15: 2, 10: 2 }, possible15: 1, probable10: 2 };
